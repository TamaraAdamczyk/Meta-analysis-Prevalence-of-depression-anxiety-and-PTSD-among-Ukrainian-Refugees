...
<img width="661" height="650" alt="image" src="https://github.com/user-attachments/assets/3894ef2b-b564-4ecc-b7c3-8361391311a4" />
...
Figure 2. Forest plot showing study‑level and pooled prevalence estimates of depression among Ukrainian refugees, based on a Paule–Mandel random‑effects model.

<img width="802" height="551" alt="image" src="https://github.com/user-attachments/assets/96556581-8e1a-4600-9f87-ee96d4fd925e" />

Figure 3. Forest plot showing study‑level and pooled prevalence estimates of anxiety among Ukrainian refugees, based on a Paule–Mandel random‑effects model.
...
<img width="1126" height="790" alt="PTSD subgroup analysis by country" src="https://github.com/user-attachments/assets/e1fefc33-77f2-44f9-ae7e-22b4adb13536" />

Figure 7. **PTSD prevalence among Ukrainian refugees by host country.** Panels A-D display study‑level prevalence estimates and 95% confidence intervals for PTSD among Ukrainian refugees, stratified by host country (Denmark, Germany, Poland, and Switzerland). Each panel shows the observed proportion from the contributing study and the corresponding pooled estimate from a random‑effects model using logit‑transformed proportions. PTSD prevalence varied substantially across countries, ranging from markedly lower estimates in Denmark (12%) to higher estimates in Germany (45%) and Poland (48%), with Switzerland showing intermediate prevalence (31%). As each subgroup consists of a single study, pooled estimates are identical to the study‑level values.
